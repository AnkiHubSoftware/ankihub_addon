...
from aqt import QColor, QDialog, QUrl, QWidget,QLabel, qconnect
...
#         self.web.page().setUrl(QUrl("http://localhost:8000/ai/bf5e66e5-1149-4f3b-99bf-31cd95ad970a/flashcard-selector-embed/?is_on_anki=true"))
...
class CustomDialog(AlwaysOnTopOfParentDialog):
...
class TermsOfServiceDialog(CustomDialog):
    ...
    def _get_embed_url(self) -> str:
        return "http://localhost:8000/ai/bf5e66e5-1149-4f3b-99bf-31cd95ad970a/flashcard-selector-embed/?is_on_anki=true"
