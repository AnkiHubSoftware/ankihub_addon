...
def _setup_protected_deck_hierarchy(
    ...
    if deck_type == "exam":
        ...
        config.upsert_block_exam_subdeck(
            core_id, due_date="2024-12-31", origin_hint=BlockExamSubdeckOrigin.SMART_SEARCH
        )
...
class TestBuildSubdecksAndMoveCardsToThem:
    ...
    def test_notes_not_moved_out_of_block_exam_subdecks(
        ...
        with anki_session_with_addon_data.profile_loaded():
            ...
            config.upsert_block_exam_subdeck(
                exam_subdeck_id, due_date="2024-12-31", origin_hint=BlockExamSubdeckOrigin.SMART_SEARCH
            )
...
class TestSuggestionsWithMedia:
    ...
    def test_with_matching_file_existing_for_deck(
        ...
        with anki_session_with_addon_data.profile_loaded():
            ...
            # Assert that the suggestion was created.
            create_change_suggestion_mock.assert_called_once()  # type: ignore
...
def test_add_to_block_exam_subdeck_pycmd(
    ...
    with anki_session_with_addon_data.profile_loaded():
        ...
        deck_config = config.deck_config(ah_did)
        assert call_args[1]["root_deck_id"] == deck_config.anki_id
...
class TestBlockExamSubdecks:
    def test_create_block_exam_subdeck(
        ...
        with anki_session_with_addon_data.profile_loaded():
            ...
            subdeck_name, was_renamed = create_block_exam_subdeck(
                root_deck_id, "Test Subdeck", due_date, origin_hint=BlockExamSubdeckOrigin.SMART_SEARCH
            )
    ...
    def test_create_subdeck_without_due_date(
        ...
        with anki_session_with_addon_data.profile_loaded():
            ...
            root_deck_name = aqt.mw.col.decks.name_if_exists(root_deck_id)
            full_name = f"{root_deck_name}::No Date Subdeck"
            subdeck = aqt.mw.col.decks.by_name(full_name)
            assert subdeck is not None
    ...
    def test_add_notes_to_block_exam_subdeck(
        ...
        with anki_session_with_addon_data.profile_loaded():
            ...
            subdeck_name, _ = create_block_exam_subdeck(
                root_deck_id, "Notes Subdeck", due_date, origin_hint=BlockExamSubdeckOrigin.SMART_SEARCH
            )

            # Create some notes
            note1 = add_anki_note(anki_did=root_deck_id)
            note2 = add_anki_note(anki_did=root_deck_id)
    ...
    def test_config_methods(
        ...
        with anki_session_with_addon_data.profile_loaded():
            ...
            config.upsert_block_exam_subdeck(
                test_subdeck_id, due_date="2024-12-31", origin_hint=BlockExamSubdeckOrigin.SMART_SEARCH
            )
            ...
            assert configs[0].config_origin == BlockExamSubdeckOrigin.SMART_SEARCH
            ...
            assert subdeck_config.config_origin == BlockExamSubdeckOrigin.SMART_SEARCH
            ...
            config.upsert_block_exam_subdeck(
                test_subdeck_id, due_date="2025-01-15", origin_hint=BlockExamSubdeckOrigin.DECK_CONTEXT_MENU
            )
            ...
            assert configs[0].config_origin == BlockExamSubdeckOrigin.SMART_SEARCH  # Origin preserved
            ...
            config.remove_block_exam_subdeck(DeckId(999))
            configs = config.get_block_exam_subdecks()
            assert len(configs) == 0
    ...
    def test_set_due_date_on_regular_subdeck(
        ...
        with anki_session_with_addon_data.profile_loaded():
            ...
            due_date = (date.today() + timedelta(days=7)).strftime("%Y-%m-%d")
            set_subdeck_due_date(subdeck_id, due_date, origin_hint=BlockExamSubdeckOrigin.DECK_CONTEXT_MENU)
    ...
    def test_move_subdeck_to_main_deck_with_nested_subdecks(
        ...
        with anki_session_with_addon_data.profile_loaded():
            ...
            due_date = (date.today() + timedelta(days=7)).strftime("%Y-%m-%d")
            subdeck_name, _ = create_block_exam_subdeck(
                main_deck_id, "Block Exam", due_date, origin_hint=BlockExamSubdeckOrigin.SMART_SEARCH
            )
...
class TestBlockExamSubdeckDialog:
    ...
    def test_dialog_creation_and_initial_screen(
        ...
        with anki_session_with_addon_data.profile_loaded():
            ...
            assert dialog.root_deck_id == root_deck_id
    ...
    def test_choose_subdeck_screen_with_existing_subdecks(
        ...
        with anki_session_with_addon_data.profile_loaded():
            ...
            root_deck_id = deck_config.anki_id
            root_deck_name = aqt.mw.col.decks.name_if_exists(root_deck_id)
            subdeck1_id = DeckId(aqt.mw.col.decks.add_normal_deck_with_name(f"{root_deck_name}::Test Subdeck 1").id)
            aqt.mw.col.decks.add_normal_deck_with_name(f"{root_deck_name}::Test Subdeck 2")
            ...
            config.upsert_block_exam_subdeck(
                subdeck1_id, due_date="2024-12-31", origin_hint=BlockExamSubdeckOrigin.SMART_SEARCH
            )
    ...
    def test_subdeck_selection_shows_add_notes_screen(
        ...
        with anki_session_with_addon_data.profile_loaded():
            ...
            root_deck_id = deck_config.anki_id
            root_deck_name = aqt.mw.col.decks.name_if_exists(root_deck_id)
            aqt.mw.col.decks.add_normal_deck_with_name(f"{root_deck_name}::Test Subdeck").id
...
class TestGetExpiredBlockExamSubdecks:
    ...
    def test_get_expired_block_exam_subdecks_none_expired(
        ...
        with anki_session_with_addon_data.profile_loaded():
            ...
            # Add configurations
            config.upsert_block_exam_subdeck(
                DeckId(100), due_date=future_date1, origin_hint=BlockExamSubdeckOrigin.SMART_SEARCH
            )
            config.upsert_block_exam_subdeck(
                DeckId(200), due_date=future_date2, origin_hint=BlockExamSubdeckOrigin.SMART_SEARCH
            )
    ...
    def test_get_expired_block_exam_subdecks_with_expired(
        ...
        with anki_session_with_addon_data.profile_loaded():
            ...
            # Add configurations
            config.upsert_block_exam_subdeck(
                DeckId(1), due_date=past_date, origin_hint=BlockExamSubdeckOrigin.SMART_SEARCH
            )
            config.upsert_block_exam_subdeck(
                DeckId(2), due_date=today_date, origin_hint=BlockExamSubdeckOrigin.SMART_SEARCH
            )
            config.upsert_block_exam_subdeck(
                DeckId(3), due_date=future_date, origin_hint=BlockExamSubdeckOrigin.SMART_SEARCH
            )
            ...
            expired_subdeck_ids = [config.subdeck_id for config in expired]
            assert DeckId(1) in expired_subdeck_ids  # past date
            assert DeckId(2) in expired_subdeck_ids  # today's date
            assert DeckId(3) not in expired_subdeck_ids  # future date
...
class TestSubscribeToIntroDeck:
    @pytest.mark.qt_no_exception_capture
    @pytest.mark.parametrize(
        "is_first_sync, intro_deck_already_configured, expected_subscribe_called",
        [
            (True, False, True),
            (False, False, False),
            (True, True, False),
